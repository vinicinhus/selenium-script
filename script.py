...
def visible_keys(driver: webdriver, locator_strategy: By, locator: str, keys: str) -> None:
    ...
    Args:
        ...
        locator_strategy (By): The locator strategy (e.g., By.ID, By.XPATH, By.NAME, etc.).
...
def visible_click(driver: webdriver, locator_strategy: By, locator: str) -> None:
    ...
    element = wait.until(ec.element_to_be_clickable((locator_strategy, locator)))
    element.click()
...
def select_option_by_value(driver: webdriver, locator_strategy: By, locator: str, option_value: str):
    ...
    select_element = wait.until(ec.presence_of_element_located((locator_strategy, locator)))
...
def switch_to_iframe(driver: webdriver, locator_strategy: By, locator: str) -> None:
    ...
    Args:
        driver (WebDriver): The Selenium WebDriver instance.
        locator_strategy (By): The locator strategy (e.g., By.ID, By.XPATH, By.NAME, etc.) for the iframe.
    ...
    """
    wait = WebDriverWait(driver, 30)
    iframe = wait.until(ec.presence_of_element_located((locator_strategy, locator)))
...
def is_element_present(driver: webdriver, locator_strategy: By, locator: str) -> bool:
    ...
    Args:
        driver (WebDriver): The Selenium WebDriver instance.
        locator_strategy (By): The locator strategy (e.g., By.ID, By.XPATH, By.NAME, etc.) for the element.
        locator (str): The value of the locator for the element.
